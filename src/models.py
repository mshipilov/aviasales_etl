...
from sqlalchemy import String, DateTime, CheckConstraint, ForeignKey, UniqueConstraint
...
class Route(Base):
    ...
    def __repr__(self) -> str:
        return f"Route(id={self.id!r}, abbr={self.abbr!r}, {self.origin!r} -> {self.destination!r})"
...
class RouteHistory(Base):
    ...
    def __repr__(self) -> str:
        return f"RouteHistory(id={self.id!r}, route_id={self.route_id!r}, extracted_at={self.extracted_at!r}, price={self.price!r}, departure_date={self.departure_date})"
